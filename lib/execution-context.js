                    ...
                    if(error){
                        ...
                        if(data){
                            ...
                            fs.writeJson(outfilename,data, function(err) {
                                ...
                                postFileOperation(target,processingTarget,iserror, self.CollectionConfig.postProcess,self.CollectionConfig.moveToFolder,self.CollectionConfig.renameExtention,(error,success)=>{
                                    if(error){
    ...
    function postFileOperation(originalFile,processedFile,isError,operation,moveToFolder,renameExtention,callback){
        ...
        if(isError){
            ...
            if(operation.toLowerCase() === 'delete'){
                ...
                fs.move(originalFile, moveToPath, function (e) {
                        if(e){
